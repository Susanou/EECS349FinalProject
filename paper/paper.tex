...
Support Vector machines (SVC). Each algorithm gives each comment a probability to be either positive or negative. 
We sum each algorithm's score and determine based on that score whether the comment is positive, negative or neutral. Below is a chart
showing the percentage of comments that were deemed positive, negative and neutral.
